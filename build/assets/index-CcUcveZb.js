...
*/var wh;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(M,S){function y(){}y.prototype=S.prototype,M.D=S.prototype,M.prototype=new y,M.prototype.constructor=M,M.C=function(v,A,U){for(var w=Array(arguments.length-2),tt=2;tt<arguments.length;tt++)w[tt-2]=arguments[tt];return S.prototype[A].apply(v,w)}}function e(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(n,e),n.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function r(M,S,y){y||(y=0);var v=Array(16);if(typeof S=="string")for(var A=0;16>A;++A)v[A]=S.charCodeAt(y++)|S.charCodeAt(y++)<<8|S.charCodeAt(y++)<<16|S.charCodeAt(y++)<<24;else for(A=0;16>A;++A)v[A]=S[y++]|S[y++]<<8|S[y++]<<16|S[y++]<<24;S=M.g[0],y=M.g[1],A=M.g[2];var U=M.g[3],w=S+(U^y&(A^U))+v[0]+3614090360&4294967295;S=y+(w<<7&4294967295|w>>>25),w=U+(A^S&(y^A))+v[1]+3905402710&4294967295,U=S+(w<<12&4294967295|w>>>20),w=A+(y^U&(S^y))+v[2]+606105819&4294967295,A=U+(w<<17&4294967295|w>>>15),w=y+(S^A&(U^S))+v[3]+3250441966&4294967295,y=A+(w<<22&4294967295|w>>>10),w=S+(U^y&(A^U))+v[4]+4118548399&4294967295,S=y+(w<<7&4294967295|w>>>25),w=U+(A^S&(y^A))+v[5]+1200080426&4294967295,U=S+(w<<12&4294967295|w>>>20),w=A+(y^U&(S^y))+v[6]+2821735955&4294967295,A=U+(w<<17&4294967295|w>>>15),w=y+(S^A&(U^S))+v[7]+4249261313&4294967295,y=A+(w<<22&4294967295|w>>>10),w=S+(U^y&(A^U))+v[8]+1770035416&4294967295,S=y+(w<<7&4294967295|w>>>25),w=U+(A^S&(y^A))+v[9]+2336552879&4294967295,U=S+(w<<12&4294967295|w>>>20),w=A+(y^U&(S^y))+v[10]+4294925233&4294967295,A=U+(w<<17&4294967295|w>>>15),w=y+(S^A&(U^S))+v[11]+2304563134&4294967295,y=A+(w<<22&4294967295|w>>>10),w=S+(U^y&(A^U))+v[12]+1804603682&4294967295,S=y+(w<<7&4294967295|w>>>25),w=U+(A^S&(y^A))+v[13]+4254626195&4294967295,U=S+(w<<12&4294967295|w>>>20),w=A+(y^U&(S^y))+v[14]+2792965006&4294967295,A=U+(w<<17&4294967295|w>>>15),w=y+(S^A&(U^S))+v[15]+1236535329&4294967295,y=A+(w<<22&4294967295|w>>>10),w=S+(A^U&(y^A))+v[1]+4129170786&4294967295,S=y+(w<<5&4294967295|w>>>27),w=U+(y^A&(S^y))+v[6]+3225465664&4294967295,U=S+(w<<9&4294967295|w>>>23),w=A+(S^y&(U^S))+v[11]+643717713&4294967295,A=U+(w<<14&4294967295|w>>>18),w=y+(U^S&(A^U))+v[0]+3921069994&4294967295,y=A+(w<<20&4294967295|w>>>12),w=S+(A^U&(y^A))+v[5]+3593408605&4294967295,S=y+(w<<5&4294967295|w>>>27),w=U+(y^A&(S^y))+v[10]+38016083&4294967295,U=S+(w<<9&4294967295|w>>>23),w=A+(S^y&(U^S))+v[15]+3634488961&4294967295,A=U+(w<<14&4294967295|w>>>18),w=y+(U^S&(A^U))+v[4]+3889429448&4294967295,y=A+(w<<20&4294967295|w>>>12),w=S+(A^U&(y^A))+v[9]+568446438&4294967295,S=y+(w<<5&4294967295|w>>>27),w=U+(y^A&(S^y))+v[14]+3275163606&4294967295,U=S+(w<<9&4294967295|w>>>23),w=A+(S^y&(U^S))+v[3]+4107603335&4294967295,A=U+(w<<14&4294967295|w>>>18),w=y+(U^S&(A^U))+v[8]+1163531501&4294967295,y=A+(w<<20&4294967295|w>>>12),w=S+(A^U&(y^A))+v[13]+2850285829&4294967295,S=y+(w<<5&4294967295|w>>>27),w=U+(y^A&(S^y))+v[2]+4243563512&4294967295,U=S+(w<<9&4294967295|w>>>23),w=A+(S^y&(U^S))+v[7]+1735328473&4294967295,A=U+(w<<14&4294967295|w>>>18),w=y+(U^S&(A^U))+v[12]+2368359562&4294967295,y=A+(w<<20&4294967295|w>>>12),w=S+(y^A^U)+v[5]+4294588738&4294967295,S=y+(w<<4&4294967295|w>>>28),w=U+(S^y^A)+v[8]+2272392833&4294967295,U=S+(w<<11&4294967295|w>>>21),w=A+(U^S^y)+v[11]+1839030562&4294967295,A=U+(w<<16&4294967295|w>>>16),w=y+(A^U^S)+v[14]+4259657740&4294967295,y=A+(w<<23&4294967295|w>>>9),w=S+(y^A^U)+v[1]+2763975236&4294967295,S=y+(w<<4&4294967295|w>>>28),w=U+(S^y^A)+v[4]+1272893353&4294967295,U=S+(w<<11&4294967295|w>>>21),w=A+(U^S^y)+v[7]+4139469664&4294967295,A=U+(w<<16&4294967295|w>>>16),w=y+(A^U^S)+v[10]+3200236656&4294967295,y=A+(w<<23&4294967295|w>>>9),w=S+(y^A^U)+v[13]+681279174&4294967295,S=y+(w<<4&4294967295|w>>>28),w=U+(S^y^A)+v[0]+3936430074&4294967295,U=S+(w<<11&4294967295|w>>>21),w=A+(U^S^y)+v[3]+3572445317&4294967295,A=U+(w<<16&4294967295|w>>>16),w=y+(A^U^S)+v[6]+76029189&4294967295,y=A+(w<<23&4294967295|w>>>9),w=S+(y^A^U)+v[9]+3654602809&4294967295,S=y+(w<<4&4294967295|w>>>28),w=U+(S^y^A)+v[12]+3873151461&4294967295,U=S+(w<<11&4294967295|w>>>21),w=A+(U^S^y)+v[15]+530742520&4294967295,A=U+(w<<16&4294967295|w>>>16),w=y+(A^U^S)+v[2]+3299628645&4294967295,y=A+(w<<23&4294967295|w>>>9),w=S+(A^(y|~U))+v[0]+4096336452&4294967295,S=y+(w<<6&4294967295|w>>>26),w=U+(y^(S|~A))+v[7]+1126891415&4294967295,U=S+(w<<10&4294967295|w>>>22),w=A+(S^(U|~y))+v[14]+2878612391&4294967295,A=U+(w<<15&4294967295|w>>>17),w=y+(U^(A|~S))+v[5]+4237533241&4294967295,y=A+(w<<21&4294967295|w>>>11),w=S+(A^(y|~U))+v[12]+1700485571&4294967295,S=y+(w<<6&4294967295|w>>>26),w=U+(y^(S|~A))+v[3]+2399980690&4294967295,U=S+(w<<10&4294967295|w>>>22),w=A+(S^(U|~y))+v[10]+4293915773&4294967295,A=U+(w<<15&4294967295|w>>>17),w=y+(U^(A|~S))+v[1]+2240044497&4294967295,y=A+(w<<21&4294967295|w>>>11),w=S+(A^(y|~U))+v[8]+1873313359&4294967295,S=y+(w<<6&4294967295|w>>>26),w=U+(y^(S|~A))+v[15]+4264355552&4294967295,U=S+(w<<10&4294967295|w>>>22),w=A+(S^(U|~y))+v[6]+2734768916&4294967295,A=U+(w<<15&4294967295|w>>>17),w=y+(U^(A|~S))+v[13]+1309151649&4294967295,y=A+(w<<21&4294967295|w>>>11),w=S+(A^(y|~U))+v[4]+4149444226&4294967295,S=y+(w<<6&4294967295|w>>>26),w=U+(y^(S|~A))+v[11]+3174756917&4294967295,U=S+(w<<10&4294967295|w>>>22),w=A+(S^(U|~y))+v[2]+718787259&4294967295,A=U+(w<<15&4294967295|w>>>17),w=y+(U^(A|~S))+v[9]+3951481745&4294967295,M.g[0]=M.g[0]+S&4294967295,M.g[1]=M.g[1]+(A+(w<<21&4294967295|w>>>11))&4294967295,M.g[2]=M.g[2]+A&4294967295,M.g[3]=M.g[3]+U&4294967295}n.prototype.u=function(M,S){S===void 0&&(S=M.length);for(var y=S-this.blockSize,v=this.B,A=this.h,U=0;U<S;){if(A==0)for(;U<=y;)r(this,M,U),U+=this.blockSize;if(typeof M=="string"){for(;U<S;)if(v[A++]=M.charCodeAt(U++),A==this.blockSize){r(this,v),A=0;break}}else for(;U<S;)if(v[A++]=M[U++],A==this.blockSize){r(this,v),A=0;break}}this.h=A,this.o+=S},n.prototype.v=function(){var M=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);M[0]=128;for(var S=1;S<M.length-8;++S)M[S]=0;var y=8*this.o;for(S=M.length-8;S<M.length;++S)M[S]=y&255,y/=256;for(this.u(M),M=Array(16),S=y=0;4>S;++S)for(var v=0;32>v;v+=8)M[y++]=this.g[S]>>>v&255;return M};function s(M,S){var y=a;return Object.prototype.hasOwnProperty.call(y,M)?y[M]:y[M]=S(M)}function o(M,S){this.h=S;for(var y=[],v=!0,A=M.length-1;0<=A;A--){var U=M[A]|0;v&&U==S||(y[A]=U,v=!1)}this.g=y}var a={};function c(M){return-128<=M&&128>M?s(M,function(S){return new o([S|0],0>S?-1:0)}):new o([M|0],0>M?-1:0)}function h(M){if(isNaN(M)||!isFinite(M))return f;if(0>M)return _(h(-M));for(var S=[],y=1,v=0;M>=y;v++)S[v]=M/y|0,y*=4294967296;return new o(S,0)}function u(M,S){if(M.length==0)throw Error("number format error: empty string");if(S=S||10,2>S||36<S)throw Error("radix out of range: "+S);if(M.charAt(0)=="-")return _(u(M.substring(1),S));if(0<=M.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=h(Math.pow(S,8)),v=f,A=0;A<M.length;A+=8){var U=Math.min(8,M.length-A),w=parseInt(M.substring(A,A+U),S);8>U?(U=h(Math.pow(S,U)),v=v.j(U).add(h(w))):(v=v.j(y),v=v.add(h(w)))}return v}var f=c(0),p=c(1),g=c(16777216);i=o.prototype,i.m=function(){if(T(this))return-_(this).m();for(var M=0,S=1,y=0;y<this.g.length;y++){var v=this.i(y);M+=(0<=v?v:4294967296+v)*S,S*=4294967296}return M},i.toString=function(M){if(M=M||10,2>M||36<M)throw Error("radix out of range: "+M);if(E(this))return"0";if(T(this))return"-"+_(this).toString(M);for(var S=h(Math.pow(M,6)),y=this,v="";;){var A=R(y,S).g;y=m(y,A.j(S));var U=((0<y.g.length?y.g[0]:y.h)>>>0).toString(M);if(y=A,E(y))return U+v;for(;6>U.length;)U="0"+U;v=U+v}},i.i=function(M){return 0>M?0:M<this.g.length?this.g[M]:this.h};function E(M){if(M.h!=0)return!1;for(var S=0;S<M.g.length;S++)if(M.g[S]!=0)return!1;return!0}function T(M){return M.h==-1}i.l=function(M){return M=m(this,M),T(M)?-1:E(M)?0:1};function _(M){for(var S=M.g.length,y=[],v=0;v<S;v++)y[v]=~M.g[v];return new o(y,~M.h).add(p)}i.abs=function(){return T(this)?_(this):this},i.add=function(M){for(var S=Math.max(this.g.length,M.g.length),y=[],v=0,A=0;A<=S;A++){var U=v+(this.i(A)&65535)+(M.i(A)&65535),w=(U>>>16)+(this.i(A)>>>16)+(M.i(A)>>>16);v=w>>>16,U&=65535,w&=65535,y[A]=w<<16|U}return new o(y,y[y.length-1]&-2147483648?-1:0)};function m(M,S){return M.add(_(S))}i.j=function(M){if(E(this)||E(M))return f;if(T(this))return T(M)?_(this).j(_(M)):_(_(this).j(M));if(T(M))return _(this.j(_(M)));if(0>this.l(g)&&0>M.l(g))return h(this.m()*M.m());for(var S=this.g.length+M.g.length,y=[],v=0;v<2*S;v++)y[v]=0;for(v=0;v<this.g.length;v++)for(var A=0;A<M.g.length;A++){var U=this.i(v)>>>16,w=this.i(v)&65535,tt=M.i(A)>>>16,J=M.i(A)&65535;y[2*v+2*A]+=w*J,N(y,2*v+2*A),y[2*v+2*A+1]+=U*J,N(y,2*v+2*A+1),y[2*v+2*A+1]+=w*tt,N(y,2*v+2*A+1),y[2*v+2*A+2]+=U*tt,N(y,2*v+2*A+2)}for(v=0;v<S;v++)y[v]=y[2*v+1]<<16|y[2*v];for(v=S;v<2*S;v++)y[v]=0;return new o(y,0)};function N(M,S){for(;(M[S]&65535)!=M[S];)M[S+1]+=M[S]>>>16,M[S]&=65535,S++}function I(M,S){this.g=M,this.h=S}function R(M,S){if(E(S))throw Error("division by zero");if(E(M))return new I(f,f);if(T(M))return S=R(_(M),S),new I(_(S.g),_(S.h));if(T(S))return S=R(M,_(S)),new I(_(S.g),S.h);if(30<M.g.length){if(T(M)||T(S))throw Error("slowDivide_ only works with positive integers.");for(var y=p,v=S;0>=v.l(M);)y=V(y),v=V(v);var A=O(y,1),U=O(v,1);for(v=O(v,2),y=O(y,2);!E(v);){var w=U.add(v);0>=w.l(M)&&(A=A.add(y),U=w),v=O(v,1),y=O(y,1)}return S=m(M,A.j(S)),new I(A,S)}for(A=f;0<=M.l(S);){for(y=Math.max(1,Math.floor(M.m()/S.m())),v=Math.ceil(Math.log(y)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),U=h(y),w=U.j(S);T(w)||0<w.l(M);)y-=v,U=h(y),w=U.j(S);E(U)&&(U=p),A=A.add(U),M=m(M,w)}return new I(A,M)}i.A=function(M){return R(this,M).h},i.and=function(M){for(var S=Math.max(this.g.length,M.g.length),y=[],v=0;v<S;v++)y[v]=this.i(v)&M.i(v);return new o(y,this.h&M.h)},i.or=function(M){for(var S=Math.max(this.g.length,M.g.length),y=[],v=0;v<S;v++)y[v]=this.i(v)|M.i(v);return new o(y,this.h|M.h)},i.xor=function(M){for(var S=Math.max(this.g.length,M.g.length),y=[],v=0;v<S;v++)y[v]=this.i(v)^M.i(v);return new o(y,this.h^M.h)};function V(M){for(var S=M.g.length+1,y=[],v=0;v<S;v++)y[v]=M.i(v)<<1|M.i(v-1)>>>31;return new o(y,M.h)}function O(M,S){var y=S>>5;S%=32;for(var v=M.g.length-y,A=[],U=0;U<v;U++)A[U]=0<S?M.i(U+y)>>>S|M.i(U+y+1)<<32-S:M.i(U+y);return new o(A,M.h)}n.prototype.digest=n.prototype.v,n.prototype.reset=n.prototype.s,n.prototype.update=n.prototype.u,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=u,wh=o}).apply(typeof $f<"u"?$f:typeof self<"u"?self:typeof window<"u"?window:{});var Zo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Vp,ws,Bp,fa,$c,kp,zp,Hp;(function(){var i,t=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,d,x){return l==Array.prototype||l==Object.prototype||(l[d]=x.value),l};function e(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof Zo=="object"&&Zo];for(var d=0;d<l.length;++d){var x=l[d];if(x&&x.Math==Math)return x}throw Error("Cannot find global object")}var n=e(this);function r(l,d){if(d)t:{var x=n;l=l.split(".");for(var P=0;P<l.length-1;P++){var G=l[P];if(!(G in x))break t;x=x[G]}l=l[l.length-1],P=x[l],d=d(P),d!=P&&d!=null&&t(x,l,{configurable:!0,writable:!0,value:d})}}function s(l,d){l instanceof String&&(l+="");var x=0,P=!1,G={next:function(){if(!P&&x<l.length){var j=x++;return{value:d(j,l[j]),done:!1}}return P=!0,{done:!0,value:void 0}}};return G[Symbol.iterator]=function(){return G},G}r("Array.prototype.values",function(l){return l||function(){return s(this,function(d,x){return x})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function c(l){var d=typeof l;return d=d!="object"?d:l?Array.isArray(l)?"array":d:"null",d=="array"||d=="object"&&typeof l.length=="number"}function h(l){var d=typeof l;return d=="object"&&l!=null||d=="function"}function u(l,d,x){return l.call.apply(l.bind,arguments)}function f(l,d,x){if(!l)throw Error();if(2<arguments.length){var P=Array.prototype.slice.call(arguments,2);return function(){var G=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(G,P),l.apply(d,G)}}return function(){return l.apply(d,arguments)}}function p(l,d,x){return p=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?u:f,p.apply(null,arguments)}function g(l,d){var x=Array.prototype.slice.call(arguments,1);return function(){var P=x.slice();return P.push.apply(P,arguments),l.apply(this,P)}}function E(l,d){function x(){}x.prototype=d.prototype,l.aa=d.prototype,l.prototype=new x,l.prototype.constructor=l,l.Qb=function(P,G,j){for(var mt=Array(arguments.length-2),Se=2;Se<arguments.length;Se++)mt[Se-2]=arguments[Se];return d.prototype[G].apply(P,mt)}}function T(l){const d=l.length;if(0<d){const x=Array(d);for(let P=0;P<d;P++)x[P]=l[P];return x}return[]}function _(l,d){for(let x=1;x<arguments.length;x++){const P=arguments[x];if(c(P)){const G=l.length||0,j=P.length||0;l.length=G+j;for(let mt=0;mt<j;mt++)l[G+mt]=P[mt]}else l.push(P)}}class m{constructor(d,x){this.i=d,this.j=x,this.h=0,this.g=null}get(){let d;return 0<this.h?(this.h--,d=this.g,this.g=d.next,d.next=null):d=this.i(),d}}function N(l){return/^[\s\xa0]*$/.test(l)}function I(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function R(l){return R[" "](l),l}R[" "]=function(){};var V=I().indexOf("Gecko")!=-1&&!(I().toLowerCase().indexOf("webkit")!=-1&&I().indexOf("Edge")==-1)&&!(I().indexOf("Trident")!=-1||I().indexOf("MSIE")!=-1)&&I().indexOf("Edge")==-1;function O(l,d,x){for(const P in l)d.call(x,l[P],P,l)}function M(l,d){for(const x in l)d.call(void 0,l[x],x,l)}function S(l){const d={};for(const x in l)d[x]=l[x];return d}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function v(l,d){let x,P;for(let G=1;G<arguments.length;G++){P=arguments[G];for(x in P)l[x]=P[x];for(let j=0;j<y.length;j++)x=y[j],Object.prototype.hasOwnProperty.call(P,x)&&(l[x]=P[x])}}function A(l){var d=1;l=l.split(":");const x=[];for(;0<d&&l.length;)x.push(l.shift()),d--;return l.length&&x.push(l.join(":")),x}function U(l){a.setTimeout(()=>{throw l},0)}function w(){var l=gt;let d=null;return l.g&&(d=l.g,l.g=l.g.next,l.g||(l.h=null),d.next=null),d}class tt{constructor(){this.h=this.g=null}add(d,x){const P=J.get();P.set(d,x),this.h?this.h.next=P:this.g=P,this.h=P}}var J=new m(()=>new Q,l=>l.reset());class Q{constructor(){this.next=this.g=this.h=null}set(d,x){this.h=d,this.g=x,this.next=null}reset(){this.next=this.g=this.h=null}}let et,$=!1,gt=new tt,wt=()=>{const l=a.Promise.resolve(void 0);et=()=>{l.then(Pt)}};var Pt=()=>{for(var l;l=w();){try{l.h.call(l.g)}catch(x){U(x)}var d=J;d.j(l),100>d.h&&(d.h++,l.next=d.g,d.g=l)}$=!1};function Ht(){this.s=this.s,this.C=this.C}Ht.prototype.s=!1,Ht.prototype.ma=function(){this.s||(this.s=!0,this.N())},Ht.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function kt(l,d){this.type=l,this.g=this.target=d,this.defaultPrevented=!1}kt.prototype.h=function(){this.defaultPrevented=!0};var Z=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,d=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const x=()=>{};a.addEventListener("test",x,d),a.removeEventListener("test",x,d)}catch{}return l}();function ft(l,d){if(kt.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var x=this.type=l.type,P=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=d,d=l.relatedTarget){if(V){t:{try{R(d.nodeName);var G=!0;break t}catch{}G=!1}G||(d=null)}}else x=="mouseover"?d=l.fromElement:x=="mouseout"&&(d=l.toElement);this.relatedTarget=d,P?(this.clientX=P.clientX!==void 0?P.clientX:P.pageX,this.clientY=P.clientY!==void 0?P.clientY:P.pageY,this.screenX=P.screenX||0,this.screenY=P.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:It[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&ft.aa.h.call(this)}}E(ft,kt);var It={2:"touch",3:"pen",4:"mouse"};ft.prototype.h=function(){ft.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var yt="closure_listenable_"+(1e6*Math.random()|0),Ft=0;function Yt(l,d,x,P,G){this.listener=l,this.proxy=null,this.src=d,this.type=x,this.capture=!!P,this.ha=G,this.key=++Ft,this.da=this.fa=!1}function Nt(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function ve(l){this.src=l,this.g={},this.h=0}ve.prototype.add=function(l,d,x,P,G){var j=l.toString();l=this.g[j],l||(l=this.g[j]=[],this.h++);var mt=Wt(l,d,P,G);return-1<mt?(d=l[mt],x||(d.fa=!1)):(d=new Yt(d,this.src,j,!!P,G),d.fa=x,l.push(d)),d};function re(l,d){var x=d.type;if(x in l.g){var P=l.g[x],G=Array.prototype.indexOf.call(P,d,void 0),j;(j=0<=G)&&Array.prototype.splice.call(P,G,1),j&&(Nt(d),l.g[x].length==0&&(delete l.g[x],l.h--))}}function Wt(l,d,x,P){for(var G=0;G<l.length;++G){var j=l[G];if(!j.da&&j.listener==d&&j.capture==!!x&&j.ha==P)return G}return-1}var L="closure_lm_"+(1e6*Math.random()|0),pt={};function ot(l,d,x,P,G){if(Array.isArray(d)){for(var j=0;j<d.length;j++)ot(l,d[j],x,P,G);return null}return x=rt(x),l&&l[yt]?l.K(d,x,h(P)?!!P.capture:!1,G):ut(l,d,x,!1,P,G)}function ut(l,d,x,P,G,j){if(!d)throw Error("Invalid event type");var mt=h(G)?!!G.capture:!!G,Se=H(l);if(Se||(l[L]=Se=new ve(l)),x=Se.add(d,x,P,mt,j),x.proxy)return x;if(P=nt(),x.proxy=P,P.src=l,P.listener=x,l.addEventListener)Z||(G=mt),G===void 0&&(G=!1),l.addEventListener(d.toString(),P,G);else if(l.attachEvent)l.attachEvent(D(d.toString()),P);else if(l.addListener&&l.removeListener)l.addListener(P);else throw Error("addEventListener and attachEvent are unavailable.");return x}function nt(){function l(x){return d.call(l.src,l.listener,x)}const d=b;return l}function Dt(l,d,x,P,G){if(Array.isArray(d))for(var j=0;j<d.length;j++)Dt(l,d[j],x,P,G);else P=h(P)?!!P.capture:!!P,x=rt(x),l&&l[yt]?(l=l.i,d=String(d).toString(),d in l.g&&(j=l.g[d],x=Wt(j,x,P,G),-1<x&&(Nt(j[x]),Array.prototype.splice.call(j,x,1),j.length==0&&(delete l.g[d],l.h--)))):l&&(l=H(l))&&(d=l.g[d.toString()],l=-1,d&&(l=Wt(d,x,P,G)),(x=-1<l?d[l]:null)&&at(x))}function at(l){if(typeof l!="number"&&l&&!l.da){var d=l.src;if(d&&d[yt])re(d.i,l);else{var x=l.type,P=l.proxy;d.removeEventListener?d.removeEventListener(x,P,l.capture):d.detachEvent?d.detachEvent(D(x),P):d.addListener&&d.removeListener&&d.removeListener(P),(x=H(d))?(re(x,l),x.h==0&&(x.src=null,d[L]=null)):Nt(l)}}}function D(l){return l in pt?pt[l]:pt[l]="on"+l}function b(l,d){if(l.da)l=!0;else{d=new ft(d,this);var x=l.listener,P=l.ha||l.src;l.fa&&at(l),l=x.call(P,d)}return l}function H(l){return l=l[L],l instanceof ve?l:null}var K="__closure_events_fn_"+(1e9*Math.random()>>>0);function rt(l){return typeof l=="function"?l:(l[K]||(l[K]=function(d){return l.handleEvent(d)}),l[K])}function W(){Ht.call(this),this.i=new ve(this),this.M=this,this.F=null}E(W,Ht),W.prototype[yt]=!0,W.prototype.removeEventListener=function(l,d,x,P){Dt(this,l,d,x,P)};function xt(l,d){var x,P=l.F;if(P)for(x=[];P;P=P.F)x.push(P);if(l=l.M,P=d.type||d,typeof d=="string")d=new kt(d,l);else if(d instanceof kt)d.target=d.target||l;else{var G=d;d=new kt(P,l),v(d,G)}if(G=!0,x)for(var j=x.length-1;0<=j;j--){var mt=d.g=x[j];G=_t(mt,P,!0,d)&&G}if(mt=d.g=l,G=_t(mt,P,!0,d)&&G,G=_t(mt,P,!1,d)&&G,x)for(j=0;j<x.length;j++)mt=d.g=x[j],G=_t(mt,P,!1,d)&&G}W.prototype.N=function(){if(W.aa.N.call(this),this.i){var l=this.i,d;for(d in l.g){for(var x=l.g[d],P=0;P<x.length;P++)Nt(x[P]);delete l.g[d],l.h--}}this.F=null},W.prototype.K=function(l,d,x,P){return this.i.add(String(l),d,!1,x,P)},W.prototype.L=function(l,d,x,P){return this.i.add(String(l),d,!0,x,P)};function _t(l,d,x,P){if(d=l.i.g[String(d)],!d)return!0;d=d.concat();for(var G=!0,j=0;j<d.length;++j){var mt=d[j];if(mt&&!mt.da&&mt.capture==x){var Se=mt.listener,Ye=mt.ha||mt.src;mt.fa&&re(l.i,mt),G=Se.call(Ye,P)!==!1&&G}}return G&&!P.defaultPrevented}function Ut(l,d,x){if(typeof l=="function")x&&(l=p(l,x));else if(l&&typeof l.handleEvent=="function")l=p(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(d)?-1:a.setTimeout(l,d||0)}function zt(l){l.g=Ut(()=>{l.g=null,l.i&&(l.i=!1,zt(l))},l.l);const d=l.h;l.h=null,l.m.apply(null,d)}class lt extends Ht{constructor(d,x){super(),this.m=d,this.l=x,this.h=null,this.i=!1,this.g=null}j(d){this.h=arguments,this.g?this.i=!0:zt(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function bt(l){Ht.call(this),this.h=l,this.g={}}E(bt,Ht);var Vt=[];function Xt(l){O(l.g,function(d,x){this.g.hasOwnProperty(x)&&at(d)},l),l.g={}}bt.prototype.N=function(){bt.aa.N.call(this),Xt(this)},bt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Rt=a.JSON.stringify,se=a.JSON.parse,Kt=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function ge(){}ge.prototype.h=null;function B(l){return l.h||(l.h=l.i())}function Tt(){}var Y={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function it(){kt.call(this,"d")}E(it,kt);function Mt(){kt.call(this,"c")}E(Mt,kt);var vt={},$t=null;function xe(){return $t=$t||new W}vt.La="serverreachability";function Fe(l){kt.call(this,vt.La,l)}E(Fe,kt);function ae(l){const d=xe();xt(d,new Fe(d))}vt.STAT_EVENT="statevent";function fn(l,d){kt.call(this,vt.STAT_EVENT,l),this.stat=d}E(fn,kt);function Me(l){const d=xe();xt(d,new fn(d,l))}vt.Ma="timingevent";function os(l,d){kt.call(this,vt.Ma,l),this.size=d}E(os,kt);function _i(l,d){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},d)}function En(){this.g=!0}En.prototype.xa=function(){this.g=!1};function as(l,d,x,P,G,j){l.info(function(){if(l.g)if(j)for(var mt="",Se=j.split("&"),Ye=0;Ye<Se.length;Ye++){var pe=Se[Ye].split("=");if(1<pe.length){var en=pe[0];pe=pe[1];var nn=en.split("_");mt=2<=nn.length&&nn[1]=="type"?mt+(en+"="+pe+"&"):mt+(en+"=redacted&")}}else mt=null;else mt=j;return"XMLHTTP REQ ("+P+") [attempt "+G+"]: "+d+`
`+x+`
`+mt})}function lo(l,d,x,P,G,j,mt){l.info(function(){return"XMLHTTP RESP ("+P+") [ attempt "+G+"]: "+d+`
`+x+`
`+j+" "+mt})}function Qn(l,d,x,P){l.info(function(){return"XMLHTTP TEXT ("+d+"): "+co(l,x)+(P?" "+P:"")})}function mr(l,d){l.info(function(){return"TIMEOUT: "+d})}En.prototype.info=function(){};function co(l,d){if(!l.g)return d;if(!d)return null;try{var x=JSON.parse(d);if(x){for(l=0;l<x.length;l++)if(Array.isArray(x[l])){var P=x[l];if(!(2>P.length)){var G=P[1];if(Array.isArray(G)&&!(1>G.length)){var j=G[0];if(j!="noop"&&j!="stop"&&j!="close")for(var mt=1;mt<G.length;mt++)G[mt]=""}}}}return Rt(x)}catch{return d}}var ti={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},ls={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},gr;function _r(){}E(_r,ge),_r.prototype.g=function(){return new XMLHttpRequest},_r.prototype.i=function(){return{}},gr=new _r;function Gn(l,d,x,P){this.j=l,this.i=d,this.l=x,this.R=P||1,this.U=new bt(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ho}function ho(){this.i=null,this.g="",this.h=!1}var uo={},cs={};function hs(l,d,x){l.L=1,l.v=Be(cn(d)),l.m=x,l.P=!0,C(l,null)}function C(l,d){l.F=Date.now(),X(l),l.A=cn(l.v);var x=l.A,P=l.R;Array.isArray(P)||(P=[String(P)]),Zh(x.i,"t",P),l.C=0,x=l.j.J,l.h=new ho,l.g=mu(l.j,x?d:null,!l.m),0<l.O&&(l.M=new lt(p(l.Y,l,l.g),l.O)),d=l.U,x=l.g,P=l.ca;var G="readystatechange";Array.isArray(G)||(G&&(Vt[0]=G.toString()),G=Vt);for(var j=0;j<G.length;j++){var mt=ot(x,G[j],P||d.handleEvent,!1,d.h||d);if(!mt)break;d.g[mt.key]=mt}d=l.H?S(l.H):{},l.m?(l.u||(l.u="POST"),d["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,d)):(l.u="GET",l.g.ea(l.A,l.u,null,d)),ae(),as(l.i,l.u,l.A,l.l,l.R,l.m)}Gn.prototype.ca=function(l){l=l.target;const d=this.M;d&&ni(l)==3?d.j():this.Y(l)},Gn.prototype.Y=function(l){try{if(l==this.g)t:{const nn=ni(this.g);var d=this.g.Ba();const Er=this.g.Z();if(!(3>nn)&&(nn!=3||this.g&&(this.h.h||this.g.oa()||ru(this.g)))){this.J||nn!=4||d==7||(d==8||0>=Er?ae(3):ae(2)),ct(this);var x=this.g.Z();this.X=x;e:if(k(this)){var P=ru(this.g);l="";var G=P.length,j=ni(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){At(this),Et(this);var mt="";break e}this.h.i=new a.TextDecoder}for(d=0;d<G;d++)this.h.h=!0,l+=this.h.i.decode(P[d],{stream:!(j&&d==G-1)});P.length=0,this.h.g+=l,this.C=0,mt=this.h.g}else mt=this.g.oa();if(this.o=x==200,lo(this.i,this.u,this.A,this.l,this.R,nn,x),this.o){if(this.T&&!this.K){e:{if(this.g){var Se,Ye=this.g;if((Se=Ye.g?Ye.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!N(Se)){var pe=Se;break e}}pe=null}if(x=pe)Qn(this.i,this.l,x,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ct(this,x);else{this.o=!1,this.s=3,Me(12),At(this),Et(this);break t}}if(this.P){x=!0;let In;for(;!this.J&&this.C<mt.length;)if(In=q(this,mt),In==cs){nn==4&&(this.s=4,Me(14),x=!1),Qn(this.i,this.l,null,"[Incomplete Response]");break}else if(In==uo){this.s=4,Me(15),Qn(this.i,this.l,mt,"[Invalid Chunk]"),x=!1;break}else Qn(this.i,this.l,In,null),Ct(this,In);if(k(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),nn!=4||mt.length!=0||this.h.h||(this.s=1,Me(16),x=!1),this.o=this.o&&x,!x)Qn(this.i,this.l,mt,"[Invalid Chunked Response]"),At(this),Et(this);else if(0<mt.length&&!this.W){this.W=!0;var en=this.j;en.g==this&&en.ba&&!en.M&&(en.j.info("Great, no buffering proxy detected. Bytes received: "+mt.length),nl(en),en.M=!0,Me(11))}}else Qn(this.i,this.l,mt,null),Ct(this,mt);nn==4&&At(this),this.o&&!this.J&&(nn==4?uu(this.j,this):(this.o=!1,X(this)))}else sg(this.g),x==400&&0<mt.indexOf("Unknown SID")?(this.s=3,Me(12)):(this.s=0,Me(13)),At(this),Et(this)}}}catch{}finally{}};function k(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function q(l,d){var x=l.C,P=d.indexOf(`
`,x);return P==-1?cs:(x=Number(d.substring(x,P)),isNaN(x)?uo:(P+=1,P+x>d.length?cs:(d=d.slice(P,P+x),l.C=P+x,d)))}Gn.prototype.cancel=function(){this.J=!0,At(this)};function X(l){l.S=Date.now()+l.I,z(l,l.I)}function z(l,d){if(l.B!=null)throw Error("WatchDog timer not null");l.B=_i(p(l.ba,l),d)}function ct(l){l.B&&(a.clearTimeout(l.B),l.B=null)}Gn.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(mr(this.i,this.A),this.L!=2&&(ae(),Me(17)),At(this),this.s=2,Et(this)):z(this,this.S-l)};function Et(l){l.j.G==0||l.J||uu(l.j,l)}function At(l){ct(l);var d=l.M;d&&typeof d.ma=="function"&&d.ma(),l.M=null,Xt(l.U),l.g&&(d=l.g,l.g=null,d.abort(),d.ma())}function Ct(l,d){try{var x=l.j;if(x.G!=0&&(x.g==l||ce(x.h,l))){if(!l.K&&ce(x.h,l)&&x.G==3){try{var P=x.Da.g.parse(d)}catch{P=null}if(Array.isArray(P)&&P.length==3){var G=P;if(G[0]==0){t:if(!x.u){if(x.g)if(x.g.F+3e3<l.F)vo(x),go(x);else break t;el(x),Me(18)}}else x.za=G[1],0<x.za-x.T&&37500>G[2]&&x.F&&x.v==0&&!x.C&&(x.C=_i(p(x.Za,x),6e3));if(1>=oe(x.h)&&x.ca){try{x.ca()}catch{}x.ca=void 0}}else zi(x,11)}else if((l.K||x.g==l)&&vo(x),!N(d))for(G=x.Da.g.parse(d),d=0;d<G.length;d++){let pe=G[d];if(x.T=pe[0],pe=pe[1],x.G==2)if(pe[0]=="c"){x.K=pe[1],x.ia=pe[2];const en=pe[3];en!=null&&(x.la=en,x.j.info("VER="+x.la));const nn=pe[4];nn!=null&&(x.Aa=nn,x.j.info("SVER="+x.Aa));const Er=pe[5];Er!=null&&typeof Er=="number"&&0<Er&&(P=1.5*Er,x.L=P,x.j.info("backChannelRequestTimeoutMs_="+P)),P=x;const In=l.g;if(In){const Eo=In.g?In.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Eo){var j=P.h;j.g||Eo.indexOf("spdy")==-1&&Eo.indexOf("quic")==-1&&Eo.indexOf("h2")==-1||(j.j=j.l,j.g=new Set,j.h&&(we(j,j.h),j.h=null))}if(P.D){const il=In.g?In.g.getResponseHeader("X-HTTP-Session-Id"):null;il&&(P.ya=il,Zt(P.I,P.D,il))}}x.G=3,x.l&&x.l.ua(),x.ba&&(x.R=Date.now()-l.F,x.j.info("Handshake RTT: "+x.R+"ms")),P=x;var mt=l;if(P.qa=pu(P,P.J?P.ia:null,P.W),mt.K){Ae(P.h,mt);var Se=mt,Ye=P.L;Ye&&(Se.I=Ye),Se.B&&(ct(Se),X(Se)),P.g=mt}else cu(P);0<x.i.length&&_o(x)}else pe[0]!="stop"&&pe[0]!="close"||zi(x,7);else x.G==3&&(pe[0]=="stop"||pe[0]=="close"?pe[0]=="stop"?zi(x,7):tl(x):pe[0]!="noop"&&x.l&&x.l.ta(pe),x.v=0)}}ae(4)}catch{}}var jt=class{constructor(l,d){this.g=l,this.map=d}};function Gt(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ot(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function oe(l){return l.h?1:l.g?l.g.size:0}function ce(l,d){return l.h?l.h==d:l.g?l.g.has(d):!1}function we(l,d){l.g?l.g.add(d):l.h=d}function Ae(l,d){l.h&&l.h==d?l.h=null:l.g&&l.g.has(d)&&l.g.delete(d)}Gt.prototype.cancel=function(){if(this.i=le(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function le(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let d=l.i;for(const x of l.g.values())d=d.concat(x.D);return d}return T(l.i)}function Bt(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(c(l)){for(var d=[],x=l.length,P=0;P<x;P++)d.push(l[P]);return d}d=[],x=0;for(P in l)d[x++]=l[P];return d}function Ve(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(c(l)||typeof l=="string"){var d=[];l=l.length;for(var x=0;x<l;x++)d.push(x);return d}d=[],x=0;for(const P in l)d[x++]=P;return d}}}function fe(l,d){if(l.forEach&&typeof l.forEach=="function")l.forEach(d,void 0);else if(c(l)||typeof l=="string")Array.prototype.forEach.call(l,d,void 0);else for(var x=Ve(l),P=Bt(l),G=P.length,j=0;j<G;j++)d.call(void 0,P[j],x&&x[j],l)}var dn=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function vi(l,d){if(l){l=l.split("&");for(var x=0;x<l.length;x++){var P=l[x].indexOf("="),G=null;if(0<=P){var j=l[x].substring(0,P);G=l[x].substring(P+1)}else j=l[x];d(j,G?decodeURIComponent(G.replace(/\+/g," ")):"")}}}function Ne(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof Ne){this.h=l.h,_e(this,l.j),this.o=l.o,this.g=l.g,$e(this,l.s),this.l=l.l;var d=l.i,x=new us;x.i=d.i,d.g&&(x.g=new Map(d.g),x.h=d.h),hn(this,x),this.m=l.m}else l&&(d=String(l).match(dn))?(this.h=!1,_e(this,d[1]||"",!0),this.o=ei(d[2]||""),this.g=ei(d[3]||"",!0),$e(this,d[4]),this.l=ei(d[5]||"",!0),hn(this,d[6]||"",!0),this.m=ei(d[7]||"")):(this.h=!1,this.i=new us(null,this.h))}Ne.prototype.toString=function(){var l=[],d=this.j;d&&l.push(xn(d,$h,!0),":");var x=this.g;return(x||d=="file")&&(l.push("//"),(d=this.o)&&l.push(xn(d,$h,!0),"@"),l.push(encodeURIComponent(String(x)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),x=this.s,x!=null&&l.push(":",String(x))),(x=this.l)&&(this.g&&x.charAt(0)!="/"&&l.push("/"),l.push(xn(x,x.charAt(0)=="/"?Ym:$m,!0))),(x=this.i.toString())&&l.push("?",x),(x=this.m)&&l.push("#",xn(x,Zm)),l.join("")};function cn(l){return new Ne(l)}function _e(l,d,x){l.j=x?ei(d,!0):d,l.j&&(l.j=l.j.replace(/:$/,""))}function $e(l,d){if(d){if(d=Number(d),isNaN(d)||0>d)throw Error("Bad port number "+d);l.s=d}else l.s=null}function hn(l,d,x){d instanceof us?(l.i=d,Jm(l.i,l.h)):(x||(d=xn(d,Km)),l.i=new us(d,l.h))}function Zt(l,d,x){l.i.set(d,x)}function Be(l){return Zt(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function ei(l,d){return l?d?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function xn(l,d,x){return typeof l=="string"?(l=encodeURI(l).replace(d,jm),x&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function jm(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var $h=/[#\/\?@]/g,$m=/[#\?:]/g,Ym=/[#\?]/g,Km=/[#\?@]/g,Zm=/#/g;function us(l,d){this.h=this.g=null,this.i=l||null,this.j=!!d}function yi(l){l.g||(l.g=new Map,l.h=0,l.i&&vi(l.i,function(d,x){l.add(decodeURIComponent(d.replace(/\+/g," ")),x)}))}i=us.prototype,i.add=function(l,d){yi(this),this.i=null,l=vr(this,l);var x=this.g.get(l);return x||this.g.set(l,x=[]),x.push(d),this.h+=1,this};function Yh(l,d){yi(l),d=vr(l,d),l.g.has(d)&&(l.i=null,l.h-=l.g.get(d).length,l.g.delete(d))}function Kh(l,d){return yi(l),d=vr(l,d),l.g.has(d)}i.forEach=function(l,d){yi(this),this.g.forEach(function(x,P){x.forEach(function(G){l.call(d,G,P,this)},this)},this)},i.na=function(){yi(this);const l=Array.from(this.g.values()),d=Array.from(this.g.keys()),x=[];for(let P=0;P<d.length;P++){const G=l[P];for(let j=0;j<G.length;j++)x.push(d[P])}return x},i.V=function(l){yi(this);let d=[];if(typeof l=="string")Kh(this,l)&&(d=d.concat(this.g.get(vr(this,l))));else{l=Array.from(this.g.values());for(let x=0;x<l.length;x++)d=d.concat(l[x])}return d},i.set=function(l,d){return yi(this),this.i=null,l=vr(this,l),Kh(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[d]),this.h+=1,this},i.get=function(l,d){return l?(l=this.V(l),0<l.length?String(l[0]):d):d};function Zh(l,d,x){Yh(l,d),0<x.length&&(l.i=null,l.g.set(vr(l,d),T(x)),l.h+=x.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],d=Array.from(this.g.keys());for(var x=0;x<d.length;x++){var P=d[x];const j=encodeURIComponent(String(P)),mt=this.V(P);for(P=0;P<mt.length;P++){var G=j;mt[P]!==""&&(G+="="+encodeURIComponent(String(mt[P]))),l.push(G)}}return this.i=l.join("&")};function vr(l,d){return d=String(d),l.j&&(d=d.toLowerCase()),d}function Jm(l,d){d&&!l.j&&(yi(l),l.i=null,l.g.forEach(function(x,P){var G=P.toLowerCase();P!=G&&(Yh(this,P),Zh(this,G,x))},l)),l.j=d}function Qm(l,d){const x=new En;if(a.Image){const P=new Image;P.onload=g(Ei,x,"TestLoadImage: loaded",!0,d,P),P.onerror=g(Ei,x,"TestLoadImage: error",!1,d,P),P.onabort=g(Ei,x,"TestLoadImage: abort",!1,d,P),P.ontimeout=g(Ei,x,"TestLoadImage: timeout",!1,d,P),a.setTimeout(function(){P.ontimeout&&P.ontimeout()},1e4),P.src=l}else d(!1)}function tg(l,d){const x=new En,P=new AbortController,G=setTimeout(()=>{P.abort(),Ei(x,"TestPingServer: timeout",!1,d)},1e4);fetch(l,{signal:P.signal}).then(j=>{clearTimeout(G),j.ok?Ei(x,"TestPingServer: ok",!0,d):Ei(x,"TestPingServer: server error",!1,d)}).catch(()=>{clearTimeout(G),Ei(x,"TestPingServer: error",!1,d)})}function Ei(l,d,x,P,G){try{G&&(G.onload=null,G.onerror=null,G.onabort=null,G.ontimeout=null),P(x)}catch{}}function eg(){this.g=new Kt}function ng(l,d,x){const P=x||"";try{fe(l,function(G,j){let mt=G;h(G)&&(mt=Rt(G)),d.push(P+j+"="+encodeURIComponent(mt))})}catch(G){throw d.push(P+"type="+encodeURIComponent("_badmap")),G}}function fo(l){this.l=l.Ub||null,this.j=l.eb||!1}E(fo,ge),fo.prototype.g=function(){return new po(this.l,this.j)},fo.prototype.i=function(l){return function(){return l}}({});function po(l,d){W.call(this),this.D=l,this.o=d,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}E(po,W),i=po.prototype,i.open=function(l,d){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=d,this.readyState=1,ds(this)},i.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const d={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(d.body=l),(this.D||a).fetch(new Request(this.A,d)).then(this.Sa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,fs(this)),this.readyState=0},i.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,ds(this)),this.g&&(this.readyState=3,ds(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Jh(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function Jh(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}i.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var d=l.value?l.value:new Uint8Array(0);(d=this.v.decode(d,{stream:!l.done}))&&(this.response=this.responseText+=d)}l.done?fs(this):ds(this),this.readyState==3&&Jh(this)}},i.Ra=function(l){this.g&&(this.response=this.responseText=l,fs(this))},i.Qa=function(l){this.g&&(this.response=l,fs(this))},i.ga=function(){this.g&&fs(this)};function fs(l){l.readyState=4,l.l=null,l.j=null,l.v=null,ds(l)}i.setRequestHeader=function(l,d){this.u.append(l,d)},i.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],d=this.h.entries();for(var x=d.next();!x.done;)x=x.value,l.push(x[0]+": "+x[1]),x=d.next();return l.join(`\r
`)};function ds(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(po.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function Qh(l){let d="";return O(l,function(x,P){d+=P,d+=":",d+=x,d+=`\r
`}),d}function Qa(l,d,x){t:{for(P in x){var P=!1;break t}P=!0}P||(x=Qh(x),typeof l=="string"?x!=null&&encodeURIComponent(String(x)):Zt(l,d,x))}function Pe(l){W.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}E(Pe,W);var ig=/^https?$/i,rg=["POST","PUT"];i=Pe.prototype,i.Ha=function(l){this.J=l},i.ea=function(l,d,x,P){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);d=d?d.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():gr.g(),this.v=this.o?B(this.o):B(gr),this.g.onreadystatechange=p(this.Ea,this);try{this.B=!0,this.g.open(d,String(l),!0),this.B=!1}catch(j){tu(this,j);return}if(l=x||"",x=new Map(this.headers),P)if(Object.getPrototypeOf(P)===Object.prototype)for(var G in P)x.set(G,P[G]);else if(typeof P.keys=="function"&&typeof P.get=="function")for(const j of P.keys())x.set(j,P.get(j));else throw Error("Unknown input type for opt_headers: "+String(P));P=Array.from(x.keys()).find(j=>j.toLowerCase()=="content-type"),G=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(rg,d,void 0))||P||G||x.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[j,mt]of x)this.g.setRequestHeader(j,mt);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{iu(this),this.u=!0,this.g.send(l),this.u=!1}catch(j){tu(this,j)}};function tu(l,d){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=d,l.m=5,eu(l),mo(l)}function eu(l){l.A||(l.A=!0,xt(l,"complete"),xt(l,"error"))}i.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,xt(this,"complete"),xt(this,"abort"),mo(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),mo(this,!0)),Pe.aa.N.call(this)},i.Ea=function(){this.s||(this.B||this.u||this.j?nu(this):this.bb())},i.bb=function(){nu(this)};function nu(l){if(l.h&&typeof o<"u"&&(!l.v[1]||ni(l)!=4||l.Z()!=2)){if(l.u&&ni(l)==4)Ut(l.Ea,0,l);else if(xt(l,"readystatechange"),ni(l)==4){l.h=!1;try{const mt=l.Z();t:switch(mt){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var d=!0;break t;default:d=!1}var x;if(!(x=d)){var P;if(P=mt===0){var G=String(l.D).match(dn)[1]||null;!G&&a.self&&a.self.location&&(G=a.self.location.protocol.slice(0,-1)),P=!ig.test(G?G.toLowerCase():"")}x=P}if(x)xt(l,"complete"),xt(l,"success");else{l.m=6;try{var j=2<ni(l)?l.g.statusText:""}catch{j=""}l.l=j+" ["+l.Z()+"]",eu(l)}}finally{mo(l)}}}}function mo(l,d){if(l.g){iu(l);const x=l.g,P=l.v[0]?()=>{}:null;l.g=null,l.v=null,d||xt(l,"ready");try{x.onreadystatechange=P}catch{}}}function iu(l){l.I&&(a.clearTimeout(l.I),l.I=null)}i.isActive=function(){return!!this.g};function ni(l){return l.g?l.g.readyState:0}i.Z=function(){try{return 2<ni(this)?this.g.status:-1}catch{return-1}},i.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.Oa=function(l){if(this.g){var d=this.g.responseText;return l&&d.indexOf(l)==0&&(d=d.substring(l.length)),se(d)}};function ru(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function sg(l){const d={};l=(l.g&&2<=ni(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let P=0;P<l.length;P++){if(N(l[P]))continue;var x=A(l[P]);const G=x[0];if(x=x[1],typeof x!="string")continue;x=x.trim();const j=d[G]||[];d[G]=j,j.push(x)}M(d,function(P){return P.join(", ")})}i.Ba=function(){return this.m},i.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function ps(l,d,x){return x&&x.internalChannelParams&&x.internalChannelParams[l]||d}function su(l){this.Aa=0,this.i=[],this.j=new En,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=ps("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=ps("baseRetryDelayMs",5e3,l),this.cb=ps("retryDelaySeedMs",1e4,l),this.Wa=ps("forwardChannelMaxRetries",2,l),this.wa=ps("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Gt(l&&l.concurrentRequestLimit),this.Da=new eg,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}i=su.prototype,i.la=8,i.G=1,i.connect=function(l,d,x,P){Me(0),this.W=l,this.H=d||{},x&&P!==void 0&&(this.H.OSID=x,this.H.OAID=P),this.F=this.X,this.I=pu(this,null,this.W),_o(this)};function tl(l){if(ou(l),l.G==3){var d=l.U++,x=cn(l.I);if(Zt(x,"SID",l.K),Zt(x,"RID",d),Zt(x,"TYPE","terminate"),ms(l,x),d=new Gn(l,l.j,d),d.L=2,d.v=Be(cn(x)),x=!1,a.navigator&&a.navigator.sendBeacon)try{x=a.navigator.sendBeacon(d.v.toString(),"")}catch{}!x&&a.Image&&(new Image().src=d.v,x=!0),x||(d.g=mu(d.j,null),d.g.ea(d.v)),d.F=Date.now(),X(d)}du(l)}function go(l){l.g&&(nl(l),l.g.cancel(),l.g=null)}function ou(l){go(l),l.u&&(a.clearTimeout(l.u),l.u=null),vo(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function _o(l){if(!Ot(l.h)&&!l.s){l.s=!0;var d=l.Ga;et||wt(),$||(et(),$=!0),gt.add(d,l),l.B=0}}function og(l,d){return oe(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=d.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=_i(p(l.Ga,l,d),fu(l,l.B)),l.B++,!0)}i.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const G=new Gn(this,this.j,l);let j=this.o;if(this.S&&(j?(j=S(j),v(j,this.S)):j=this.S),this.m!==null||this.O||(G.H=j,j=null),this.P)t:{for(var d=0,x=0;x<this.i.length;x++){e:{var P=this.i[x];if("__data__"in P.map&&(P=P.map.__data__,typeof P=="string")){P=P.length;break e}P=void 0}if(P===void 0)break;if(d+=P,4096<d){d=x;break t}if(d===4096||x===this.i.length-1){d=x+1;break t}}d=1e3}else d=1e3;d=lu(this,G,d),x=cn(this.I),Zt(x,"RID",l),Zt(x,"CVER",22),this.D&&Zt(x,"X-HTTP-Session-Id",this.D),ms(this,x),j&&(this.O?d="headers="+encodeURIComponent(String(Qh(j)))+"&"+d:this.m&&Qa(x,this.m,j)),we(this.h,G),this.Ua&&Zt(x,"TYPE","init"),this.P?(Zt(x,"$req",d),Zt(x,"SID","null"),G.T=!0,hs(G,x,null)):hs(G,x,d),this.G=2}}else this.G==3&&(l?au(this,l):this.i.length==0||Ot(this.h)||au(this))};function au(l,d){var x;d?x=d.l:x=l.U++;const P=cn(l.I);Zt(P,"SID",l.K),Zt(P,"RID",x),Zt(P,"AID",l.T),ms(l,P),l.m&&l.o&&Qa(P,l.m,l.o),x=new Gn(l,l.j,x,l.B+1),l.m===null&&(x.H=l.o),d&&(l.i=d.D.concat(l.i)),d=lu(l,x,1e3),x.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),we(l.h,x),hs(x,P,d)}function ms(l,d){l.H&&O(l.H,function(x,P){Zt(d,P,x)}),l.l&&fe({},function(x,P){Zt(d,P,x)})}function lu(l,d,x){x=Math.min(l.i.length,x);var P=l.l?p(l.l.Na,l.l,l):null;t:{var G=l.i;let j=-1;for(;;){const mt=["count="+x];j==-1?0<x?(j=G[0].g,mt.push("ofs="+j)):j=0:mt.push("ofs="+j);let Se=!0;for(let Ye=0;Ye<x;Ye++){let pe=G[Ye].g;const en=G[Ye].map;if(pe-=j,0>pe)j=Math.max(0,G[Ye].g-100),Se=!1;else try{ng(en,mt,"req"+pe+"_")}catch{P&&P(en)}}if(Se){P=mt.join("&");break t}}}return l=l.i.splice(0,x),d.D=l,P}function cu(l){if(!l.g&&!l.u){l.Y=1;var d=l.Fa;et||wt(),$||(et(),$=!0),gt.add(d,l),l.v=0}}function el(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=_i(p(l.Fa,l),fu(l,l.v)),l.v++,!0)}i.Fa=function(){if(this.u=null,hu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=_i(p(this.ab,this),l)}},i.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Me(10),go(this),hu(this))};function nl(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function hu(l){l.g=new Gn(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var d=cn(l.qa);Zt(d,"RID","rpc"),Zt(d,"SID",l.K),Zt(d,"AID",l.T),Zt(d,"CI",l.F?"0":"1"),!l.F&&l.ja&&Zt(d,"TO",l.ja),Zt(d,"TYPE","xmlhttp"),ms(l,d),l.m&&l.o&&Qa(d,l.m,l.o),l.L&&(l.g.I=l.L);var x=l.g;l=l.ia,x.L=1,x.v=Be(cn(d)),x.m=null,x.P=!0,C(x,l)}i.Za=function(){this.C!=null&&(this.C=null,go(this),el(this),Me(19))};function vo(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function uu(l,d){var x=null;if(l.g==d){vo(l),nl(l),l.g=null;var P=2}else if(ce(l.h,d))x=d.D,Ae(l.h,d),P=1;else return;if(l.G!=0){if(d.o)if(P==1){x=d.m?d.m.length:0,d=Date.now()-d.F;var G=l.B;P=xe(),xt(P,new os(P,x)),_o(l)}else cu(l);else if(G=d.s,G==3||G==0&&0<d.X||!(P==1&&og(l,d)||P==2&&el(l)))switch(x&&0<x.length&&(d=l.h,d.i=d.i.concat(x)),G){case 1:zi(l,5);break;case 4:zi(l,10);break;case 3:zi(l,6);break;default:zi(l,2)}}}function fu(l,d){let x=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(x*=2),x*d}function zi(l,d){if(l.j.info("Error code "+d),d==2){var x=p(l.fb,l),P=l.Xa;const G=!P;P=new Ne(P||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||_e(P,"https"),Be(P),G?Qm(P.toString(),x):tg(P.toString(),x)}else Me(2);l.G=0,l.l&&l.l.sa(d),du(l),ou(l)}i.fb=function(l){l?(this.j.info("Successfully pinged google.com"),Me(2)):(this.j.info("Failed to ping google.com"),Me(1))};function du(l){if(l.G=0,l.ka=[],l.l){const d=le(l.h);(d.length!=0||l.i.length!=0)&&(_(l.ka,d),_(l.ka,l.i),l.h.i.length=0,T(l.i),l.i.length=0),l.l.ra()}}function pu(l,d,x){var P=x instanceof Ne?cn(x):new Ne(x);if(P.g!="")d&&(P.g=d+"."+P.g),$e(P,P.s);else{var G=a.location;P=G.protocol,d=d?d+"."+G.hostname:G.hostname,G=+G.port;var j=new Ne(null);P&&_e(j,P),d&&(j.g=d),G&&$e(j,G),x&&(j.l=x),P=j}return x=l.D,d=l.ya,x&&d&&Zt(P,x,d),Zt(P,"VER",l.la),ms(l,P),P}function mu(l,d,x){if(d&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return d=l.Ca&&!l.pa?new Pe(new fo({eb:x})):new Pe(l.pa),d.Ha(l.J),d}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function gu(){}i=gu.prototype,i.ua=function(){},i.ta=function(){},i.sa=function(){},i.ra=function(){},i.isActive=function(){return!0},i.Na=function(){};function yo(){}yo.prototype.g=function(l,d){return new Sn(l,d)};function Sn(l,d){W.call(this),this.g=new su(d),this.l=l,this.h=d&&d.messageUrlParams||null,l=d&&d.messageHeaders||null,d&&d.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=d&&d.initMessageHeaders||null,d&&d.messageContentType&&(l?l["X-WebChannel-Content-Type"]=d.messageContentType:l={"X-WebChannel-Content-Type":d.messageContentType}),d&&d.va&&(l?l["X-WebChannel-Client-Profile"]=d.va:l={"X-WebChannel-Client-Profile":d.va}),this.g.S=l,(l=d&&d.Sb)&&!N(l)&&(this.g.m=l),this.v=d&&d.supportsCrossDomainXhr||!1,this.u=d&&d.sendRawJson||!1,(d=d&&d.httpSessionIdParam)&&!N(d)&&(this.g.D=d,l=this.h,l!==null&&d in l&&(l=this.h,d in l&&delete l[d])),this.j=new yr(this)}E(Sn,W),Sn.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Sn.prototype.close=function(){tl(this.g)},Sn.prototype.o=function(l){var d=this.g;if(typeof l=="string"){var x={};x.__data__=l,l=x}else this.u&&(x={},x.__data__=Rt(l),l=x);d.i.push(new jt(d.Ya++,l)),d.G==3&&_o(d)},Sn.prototype.N=function(){this.g.l=null,delete this.j,tl(this.g),delete this.g,Sn.aa.N.call(this)};function _u(l){it.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var d=l.__sm__;if(d){t:{for(const x in d){l=x;break t}l=void 0}(this.i=l)&&(l=this.i,d=d!==null&&l in d?d[l]:void 0),this.data=d}else this.data=l}E(_u,it);function vu(){Mt.call(this),this.status=1}E(vu,Mt);function yr(l){this.g=l}E(yr,gu),yr.prototype.ua=function(){xt(this.g,"a")},yr.prototype.ta=function(l){xt(this.g,new _u(l))},yr.prototype.sa=function(l){xt(this.g,new vu)},yr.prototype.ra=function(){xt(this.g,"b")},yo.prototype.createWebChannel=yo.prototype.g,Sn.prototype.send=Sn.prototype.o,Sn.prototype.open=Sn.prototype.m,Sn.prototype.close=Sn.prototype.close,Hp=function(){return new yo},zp=function(){return xe()},kp=vt,$c={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},ti.NO_ERROR=0,ti.TIMEOUT=8,ti.HTTP_ERROR=6,fa=ti,ls.COMPLETE="complete",Bp=ls,Tt.EventType=Y,Y.OPEN="a",Y.CLOSE="b",Y.ERROR="c",Y.MESSAGE="d",W.prototype.listen=W.prototype.K,ws=Tt,Pe.prototype.listenOnce=Pe.prototype.L,Pe.prototype.getLastError=Pe.prototype.Ka,Pe.prototype.getLastErrorCode=Pe.prototype.Ba,Pe.prototype.getStatus=Pe.prototype.Z,Pe.prototype.getResponseJson=Pe.prototype.Oa,Pe.prototype.getResponseText=Pe.prototype.oa,Pe.prototype.send=Pe.prototype.ea,Pe.prototype.setWithCredentials=Pe.prototype.Ha,Vp=Pe}).apply(typeof Zo<"u"?Zo:typeof self<"u"?self:typeof window<"u"?window:{});const Yf="@firebase/firestore",Kf="4.7.11";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on="WebChannelConnection";class hb extends lb{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Ko(t,e,n,r){const s=rh();return new Promise((o,a)=>{const c=new Vp;c.setWithCredentials(!0),c.listenOnce(Bp.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case fa.NO_ERROR:const u=c.getResponseJson();Lt(on,`XHR for RPC '${t}' ${s} received:`,JSON.stringify(u)),o(u);break;case fa.TIMEOUT:Lt(on,`RPC '${t}' ${s} timed out`),a(new qt(ht.DEADLINE_EXCEEDED,"Request time out"));break;case fa.HTTP_ERROR:const f=c.getStatus();if(Lt(on,`RPC '${t}' ${s} failed with status:`,f,"response text:",c.getResponseText()),f>0){let p=c.getResponseJson();Array.isArray(p)&&(p=p[0]);const g=p==null?void 0:p.error;if(g&&g.status&&g.message){const E=function(_){const m=_.toLowerCase().replace(/_/g,"-");return Object.values(ht).indexOf(m)>=0?m:ht.UNKNOWN}(g.status);a(new qt(E,g.message))}else a(new qt(ht.UNKNOWN,"Server responded with status "+c.getStatus()))}else a(new qt(ht.UNAVAILABLE,"Connection failed."));break;default:ie(9055,{s_:t,streamId:s,o_:c.getLastErrorCode(),__:c.getLastError()})}}finally{Lt(on,`RPC '${t}' ${s} completed.`)}});const h=JSON.stringify(r);Lt(on,`RPC '${t}' ${s} sending request:`,r),c.send(e,"POST",h,n,15)})}a_(t,e,n){const r=rh(),s=[this.Lo,"/","google.firestore.v1.Firestore","/",t,"/channel"],o=Hp(),a=zp(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(c.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Uo(c.initMessageHeaders,e,n),c.encodeInitMessageHeaders=!0;const u=s.join("");Lt(on,`Creating RPC '${t}' stream ${r}: ${u}`,c);const f=o.createWebChannel(u,c);let p=!1,g=!1;const E=new cb({Go:_=>{g?Lt(on,`Not sending because RPC '${t}' stream ${r} is closed:`,_):(p||(Lt(on,`Opening RPC '${t}' stream ${r} transport.`),f.open(),p=!0),Lt(on,`RPC '${t}' stream ${r} sending:`,_),f.send(_))},zo:()=>f.close()}),T=(_,m,N)=>{_.listen(m,I=>{try{N(I)}catch(R){setTimeout(()=>{throw R},0)}})};return T(f,ws.EventType.OPEN,()=>{g||(Lt(on,`RPC '${t}' stream ${r} transport opened.`),E.t_())}),T(f,ws.EventType.CLOSE,()=>{g||(g=!0,Lt(on,`RPC '${t}' stream ${r} transport closed`),E.r_())}),T(f,ws.EventType.ERROR,_=>{g||(g=!0,Ga(on,`RPC '${t}' stream ${r} transport errored. Name:`,_.name,"Message:",_.message),E.r_(new qt(ht.UNAVAILABLE,"The operation could not be completed")))}),T(f,ws.EventType.MESSAGE,_=>{var m;if(!g){const N=_.data[0];Le(!!N,16349);const I=N,R=(I==null?void 0:I.error)||((m=I[0])===null||m===void 0?void 0:m.error);if(R){Lt(on,`RPC '${t}' stream ${r} received error:`,R);const V=R.status;let O=function(y){const v=Oe[y];if(v!==void 0)return vA(v)}(V),M=R.message;O===void 0&&(O=ht.INTERNAL,M="Unknown error status: "+V+" with message "+R.message),g=!0,E.r_(new qt(O,M)),f.close()}else Lt(on,`RPC '${t}' stream ${r} received:`,N),E.i_(N)}}),T(a,kp.STAT_EVENT,_=>{_.stat===$c.PROXY?Lt(on,`RPC '${t}' stream ${r} detected buffering proxy`):_.stat===$c.NOPROXY&&Lt(on,`RPC '${t}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{E.n_()},0),E}}function ql(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,document.body.appendChild(e),setTimeout(()=>{e.classList.add("active")},10),document.getElementById("submit-results").addEventListener("click",()=>{document.querySelector(".results-form").classList.add("loading"),mw(i,t)}),document.getElementById("close-modal").addEventListener("click",oh),e.addEventListener("click",n=>{n.target===e&&oh()})}async function mw(i,t,e){const n=document.getElementById("form-name"),r=document.getElementById("form-email"),s=document.getElementById("form-phone"),o=document.getElementById("form-score"),a=document.getElementById("submit-results");a.disabled=!0,a.textContent="Enviando...";const c=n.value.trim(),h=r.value.trim(),u=s.value.trim(),f=o.value.trim();[n,r,s,o].forEach(N=>N.classList.remove("invalid"));const g={name:document.getElementById("error-name"),email:document.getElementById("error-email"),phone:document.getElementById("error-phone"),score:document.getElementById("error-score")};Object.values(g).forEach(N=>N.style.display="none");let E=!1;c||(n.classList.add("invalid"),g.name.style.display="block",E=!0),(!h||!/^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/.test(h))&&(r.classList.add("invalid"),g.email.style.display="block",E=!0),/^[0-9]{8,}$/.test(u)||(s.classList.add("invalid"),g.phone.style.display="block",E=!0);const _=parseInt(f,10);if(f!==""&&(isNaN(_)||_<1||_>100)&&(o.classList.add("invalid"),g.score.style.display="block",E=!0),E){a.disabled=!1,a.textContent="Enviar";return}const m={name:c,email:h,phone:u,score:isNaN(_)?null:_,leftPercentage:i,rightPercentage:t,timestamp:new Date};try{await ow(m),alert("Resultado guardado correctamente."),oh()}catch(N){alert("Error al guardar: "+N.message),a.disabled=!1,a.textContent="Enviar"}}function oh(){const i=document.querySelector(".results-modal");i&&i.remove()}ao();
